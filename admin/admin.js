...
(function () {
  ...
  */
  ...
  function wireRichEditor(wrap) {
    ...
    /* The translate button writes straight into the hidden source textarea, which
       the contenteditable pane knows nothing about — so without this the pane kept
       showing the pre-translation article, and the operator's very next keystroke
       ran syncFromVisual and wrote that stale copy back over the translation. */
