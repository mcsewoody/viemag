...
window.VIEMAG_SCHEMA = {
  products: {
    ...
    fields: [
      ...
      { name: 'internal_cat', type: 'select', options: ['CAT-A', 'CAT-B', 'CAT-C', 'CAT-D', 'CAT-E'], internal: true, desc: 'Internal CAT-A to CAT-E classification code (a separate field on categories carries the version shown on the site).' },
  ...
  categories: {
    ...
    fields: [
      ...
      { name: 'internal_cat_mapping', type: 'select', options: ['CAT-A', 'CAT-B', 'CAT-C', 'CAT-D', 'CAT-E'], desc: 'Maps to the White Paper’s CAT-A to CAT-E code. This one IS shown on the category card, unlike products.internal_cat.' },
