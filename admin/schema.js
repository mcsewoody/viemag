...
window.VIEMAG_SCHEMA = {
  ...
  products: {
    ...
    fields: [
      ...
      { name: 'product_article_en', type: 'textarea', large: true, editor: 'productArticle', desc: 'Long-form product article shown below the main product specs. Use the toolbar for bold, italic, headings, bullets and inline image layouts. Leave blank and the article section is hidden.' },
