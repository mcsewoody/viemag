...
window.VIEMAG_SCHEMA = {
  ...
  products: {
    ...
    fields: [
      ...
      { name: 'product_article_en', type: 'textarea', large: true, editor: 'productArticle', desc: 'Long-form product article shown in the Product Details tab. Use the toolbar for bold, italic, headings, bullets, inline image layouts and YouTube embeds. Linked headings use ## [Heading](https://example.com). Add a local/public video as its own line: ![video](https://example.com/demo.mp4). Leave blank and the article tab stays empty.' },
