...
window.VIEMAG_SCHEMA = {
  ...
  products: {
    ...
    fields: [
      ...
      { name: 'technical_content_en', type: 'textarea', large: true, editor: 'productArticle', desc: 'Flexible content for the Specifications tab (English). Use it for product-size tables, annotated technical images, diagrams, or extra dealer-facing notes. Two-column table rows can be typed as `| Dimension | 64 x 64 x 82 mm |`.' },
      { name: 'technical_content_vi', type: 'textarea', large: true, editor: 'productArticle', desc: 'Flexible content for the Specifications tab (Vietnamese). Same formatting tools as technical_content_en.' },
      { name: 'technical_content_id', type: 'textarea', large: true, editor: 'productArticle', desc: 'Flexible content for the Specifications tab (Indonesian). Same formatting tools as technical_content_en.' },
      { name: 'technical_content_zh', type: 'textarea', large: true, editor: 'productArticle', desc: 'Flexible content for the Specifications tab (Traditional Chinese). Simplified is converted automatically.' },
