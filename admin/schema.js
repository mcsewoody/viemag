...
window.VIEMAG_SCHEMA = {
  ...
  products: {
    ...
    tabs: [
      { key: 'front', groups: [
        ...
        { key: 'targeting', fields: ['persona', 'consumer_pain_point', 'use_cases'] },
    ...
    fields: [
      ...
      { name: 'use_cases', type: 'multiselect', options: ['car', 'desk', 'home', 'travel', 'outdoor', 'ride'], desc: 'Where this product actually gets used. Shown as chips on the product page and used for marketing copy. Unlike the category it is many-to-many and can be changed at any time — it is the escape hatch for a product that genuinely spans several situations.' },
  ...
  scenarios: {
    ...
    fields: [
      ...
      { name: 'scenario_code', type: 'select', options: ['S1', 'S2', 'S3', 'S4', 'S5', 'S6'], desc: 'The S1–S6 code shown on the scenario page. Scenarios are curated editorial since 2026-08-16 — they are no longer a product field and no longer drive a listing filter.' },
