...
window.I18N_DICT = {
  ...
  vi: {
    ...
    'why.c3.t': 'Bền hơn', 'why.c3.d': 'Mọi khớp nối, trục xoay và cơ cấu khóa đều đạt kiểm định và thử nghiệm chuẩn ô tô, giữ chất lượng qua thời gian dài sử dụng — VIEMAG xứng đáng với niềm tin của bạn.',
  ...
  en: {
    ...
    'why.claims.title': 'Three promises',
    ...
    'why.c3.t': 'Longer-lasting', 'why.c3.d': 'Every joint, pivot and locking mechanism passes automotive-grade certification and testing, holding its quality through long-term use — VIEMAG earns your trust.',
  ...
  zh: {
    ...
    'why.claims.title': '三個承諾',
    'why.c1.t': '更穩定', 'why.c1.d': 'N52 超強磁鐵、通過多方向磁力推拉實測與實路況震動測試，讓您的手機穩定吸附於 VIEMAG 的產品上。',
    'why.c2.t': '更牢靠', 'why.c2.d': '我們採用高品質吸盤、特殊材質PU黏膠吸盤、3M保證壓克力膠、專業機構設計，每個固定方式都牢靠，VIEMAG 承載您與手機的安全。',
    'why.c3.t': '更耐用', 'why.c3.d': '每一個關節、轉軸、結合機構都經過車規認證與測試，長時間使用仍然能確保品質，VIEMAG 值得您信賴。',
    ...
    'footer.desc': '為開車與桌面工作而生的磁吸配件系統<br>——更穩定、更牢靠、更耐用。',
    'footer.products': '產品',
    'footer.support': '售後支援',
    'footer.company': '品牌',
  ...
  'zh-Hans': {
    ...
    'hero.slogan': '磁吸，<em>解放双手</em>，<br>稳定就位',
    'hero.imgAlt': '手机吸附在车用磁吸支架上，屏幕显示导航画面',
    'hero.sub': 'VIEMAG 是为每天开车与桌面工作的人设计的磁吸配件系统：<br>比白牌 更稳定、更精致、更耐用。',
    'hero.trust1': '12 个月保修',
    ...
    'why.claims.title': '三个承诺',
    'why.c1.t': '更稳定',
    'why.c1.d': 'N52 超强磁铁、通过多方向磁力推拉实测与实路况震动测试，让您的手机稳定吸附于 VIEMAG 的产品上。',
    'why.c2.t': '更牢靠',
    'why.c2.d': '我们采用高品质吸盘、特殊材质PU黏胶吸盘、3M保证亚克力胶、专业机构设计，每个固定方式都牢靠，VIEMAG 承载您与手机的安全。',
    'why.c3.t': '更耐用',
    'why.c3.d': '每一个关节、转轴、结合机构都经过车规认证与测试，长时间使用仍然能确保品质，VIEMAG 值得您信赖。',
    ...
    'footer.desc': '为开车与桌面工作而生的磁吸配件系统<br>——更稳定、更牢靠、更耐用。',
    'footer.products': '产品',
    'footer.support': '售后支持',
    'footer.company': '品牌',
  ...
  id: {
    ...
    'why.c3.t': 'Lebih awet', 'why.c3.d': 'Setiap sambungan, poros, dan mekanisme pengunci lolos sertifikasi dan pengujian standar otomotif, menjaga kualitas untuk pemakaian jangka panjang — VIEMAG layak Anda percaya.',
