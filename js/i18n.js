...
window.I18N_DICT = {
  ...
  vi: {
    ...
    'pains.2.title': 'Càng sạc càng nóng, càng nóng càng chậm',
    'pains.2.desc': 'Cuộn sạc rẻ tiền lệch tâm khiến máy nóng ran; trưa nắng trong xe còn kích hoạt bảo vệ nhiệt và ngắt sạc.',
    'pains.2.fix': 'Mỗi mẫu sạc đều qua kiểm tra tăng nhiệt; bản 25W thêm quạt tản nhiệt chủ động.',
  ...
  en: {
    ...
    'pains.2.title': 'Hotter to charge, slower to fill',
    'pains.2.desc': 'Cheap misaligned coils cook the phone; a sun-baked cabin can even trip thermal protection and cut charging off.',
    'pains.2.fix': 'Thermal-rise testing on every charger; the 25W flagship adds an active cooling fan.',
  ...
  zh: {
    ...
    'pains.2.title': '越充越燙，越燙越慢',
    'pains.2.desc': '廉價線圈對位不準，邊充邊發燙；曬過太陽的車內甚至觸發高溫保護，直接斷充。',
    'pains.2.fix': '每款充電產品都做溫升測試，25W 旗艦再加主動散熱風扇。',
  ...
  id: {
    ...
    'pains.2.title': 'Makin panas mengisi, makin lambat penuh',
    'pains.2.desc': 'Koil murah yang tidak presisi membuat ponsel panas; kabin yang terpapar matahari bahkan bisa memicu proteksi suhu dan memutus pengisian.',
    'pains.2.fix': 'Uji kenaikan suhu pada setiap pengisi daya; model 25W dilengkapi kipas pendingin aktif.',
