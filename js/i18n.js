...
window.I18N_DICT = {
  ...
  vi: {
    ...
    'products.aboutBody': 'Danh mục VIEMAG được sắp xếp theo dòng sản phẩm, tương ứng với nơi sản phẩm được dùng: trên xe, trên bàn làm việc, hay khi di chuyển. Mỗi mã sản phẩm (A01, PQ02, V01…) ứng với một cấu hình gắn và sạc cụ thể, nên các model trong cùng một dòng có thể so sánh trực tiếp với nhau.',
    ...
    'pdp.spec.dimensions': 'Kích thước sản phẩm',
    ...
    'pdp.discontinued': 'Sản phẩm đã ngừng bán. Trang này được giữ lại để bạn tra thông số và liên hệ bảo hành.',
    'qi.none': 'Không sạc',
    'qi.compatible': 'Thiết kế theo chuẩn Qi2',
    'qi.testing': 'Thiết kế theo chuẩn Qi2.2 (đang kiểm định)',
    'qi.certified': 'Chứng nhận Qi2',
    'mount.vent': 'Cửa gió', 'mount.dashboard': 'Táp-lô',
    'mount.suction': 'Đế hút chân không', 'mount.pu-suction': 'Đế hút keo nano',
    'mount.clip': 'Kẹp lò xo', 'mount.clamp': 'Kẹp xoay', 'mount.screw': 'Cố định bằng vít',
    'mount.quarter-inch': 'Ren 1/4" cho chân máy', 'mount.magnetic': 'Đế nam châm',
    ...
    'why.c1.t': 'Ổn định hơn', 'why.c1.d': 'Nam châm lực mạnh N52, kiểm chứng bằng thử nghiệm lực hút–đẩy đa hướng và rung xóc trên cung đường thật — điện thoại luôn hút chắc trên mọi sản phẩm VIEMAG.',
    'why.c2.t': 'Chắc chắn hơn', 'why.c2.d': 'Đế hút cao cấp, miếng keo PU đặc biệt, keo acrylic 3M và thiết kế cơ khí chuyên nghiệp — mọi kiểu cố định đều chắc chắn. VIEMAG gánh vác an toàn cho bạn và chiếc điện thoại.',
    ...
    'dealers.w2.t': 'Bằng chứng chất lượng', 'dealers.w2.d': 'Báo cáo kiểm tra và chính sách bảo hành {m} tháng làm vũ khí bán hàng.',
    ...
    'about.story1': 'VIEMAG ra đời từ một quan sát đơn giản: điện thoại là vật được cầm lên – đặt xuống nhiều nhất trong ngày, nhưng đa số phụ kiện giữ nó lại làm rất cẩu thả: hút không chắc, cố định không vững, vài tháng là khớp lỏng.',
    'about.story2': 'Chúng tôi tin một phụ kiện tốt phải được làm như một tác phẩm thủ công — có thẩm mỹ, có phong cách, thiết kế xuất sắc và chất lượng vượt trội. Cái tên VIEMAG mang bốn lời hứa:',
    'about.story3': '',
  ...
  en: {
    ...
    'products.aboutBody': 'The VIEMAG catalogue is organised by product line, which follows where a product is used: in the car, on the desk, or on the move. Every product code (A01, PQ02, V01…) maps to one specific mounting and charging configuration, so models within a line can be compared side by side.',
    ...
    'pdp.spec.dimensions': 'Product dimensions',
    ...
    'pdp.discontinued': 'This product is no longer sold. The page stays up so you can still check its specs and reach support.',
    'qi.none': 'No charging',
    'qi.compatible': 'Built to the Qi2 standard',
    'qi.testing': 'Built to Qi2.2 (certification in progress)',
    'qi.certified': 'Qi2 certified',
    'mount.vent': 'Vent', 'mount.dashboard': 'Dashboard',
    'mount.suction': 'Vacuum suction', 'mount.pu-suction': 'Nano-adhesive pad',
    'mount.clip': 'Spring clip', 'mount.clamp': 'Rotating clamp', 'mount.screw': 'Screw-fixed',
    'mount.quarter-inch': '1/4" camera thread', 'mount.magnetic': 'Magnetic base',
    ...
    'why.c1.t': 'Steadier', 'why.c1.d': 'N52 high-power magnets, proven with multi-direction push-pull force tests and real-road vibration testing — your phone stays firmly locked onto every VIEMAG product.',
    'why.c2.t': 'More secure', 'why.c2.d': 'Premium suction cups, special PU adhesive gel pads, 3M acrylic adhesive and professional mechanical design — every mounting method holds fast. VIEMAG carries the safety of you and your phone.',
    ...
    'support.p1': '{m}-month warranty covering material and manufacturing defects.',
    'support.p2': 'Defective on arrival: replaced within {d} days (photo/video required).',
    ...
    'dealers.w2.t': 'Quality evidence', 'dealers.w2.d': 'Test reports and a {m}-month warranty as your selling weapons.',
    ...
    'about.story1': 'VIEMAG began with a simple observation: the phone is the object we pick up and put down more than anything else in a day — yet most accessories that hold it are made carelessly: weak magnets, insecure mounting, joints that loosen within months.',
    'about.story2': 'We believe a good accessory should be made like a crafted object — with aesthetics, with character, excellent in design and outstanding in quality. The name VIEMAG carries four promises:',
    'about.story3': '',
  ...
  zh: {
    ...
    'products.aboutBody': 'VIEMAG 型錄依產品線編排，對應產品實際使用的位置：車上、桌面，或隨身移動時。每一組產品編碼（A01、PQ02、V01⋯）對應一種固定的安裝與充電配置，同一條產品線內的型號可以直接互相比較。',
    'sort.featured': '精選',
    'sort.name': '名稱 A–Z',
    ...
    'qi.certified': 'Qi2 認證',
    'mount.vent': '出風口', 'mount.dashboard': '儀表板',
    'mount.suction': '真空吸盤', 'mount.pu-suction': '奈米膠吸盤',
    'mount.clip': '彈簧夾', 'mount.clamp': '旋轉夾持', 'mount.screw': '螺絲鎖固',
    'mount.quarter-inch': '1/4" 相機螺牙', 'mount.magnetic': '磁吸底座',
    ...
    'why.c1.t': '更穩固', 'why.c1.d': 'N52 超強磁鐵，通過多方向磁力推拉實測與實路況震動測試，讓您的手機穩固吸附於 VIEMAG 的產品上。',
    'why.c2.t': '更牢靠', 'why.c2.d': '我們採用高品質吸盤、特殊材質PU黏膠吸盤、3M保證壓克力膠、專業機構設計，每個固定方式都牢靠，VIEMAG 承載您與手機的安全。',
    ...
    'dealers.w2.t': '品質證據', 'dealers.w2.d': '測試報告與 {m} 個月保固，就是你的銷售武器。',
    ...
    'about.story1': 'VIEMAG 源自一個簡單的觀察：手機是一天中被拿起、放下最多次的物件，但多數固定它的配件都做得很隨便——磁吸不緊、固定不牢靠、用幾個月關節就鬆動。',
    'about.story2': '我們相信好的配件應該像工藝品一樣，有美感、有格調，設計卓越，品質出眾。VIEMAG 這個名字承載四個承諾：',
    'about.story3': '',
    'about.v': '超越價格的價值定位。',
    'about.i': '洞察並滿足您的需求。',
    'about.e': '追求每個細節與品質。',
  ...
  'zh-Hans': {
    ...
    'hero.trust3': '本地语言客服',
    'pains.kicker': '是不是很熟悉？',
    'pains.title': '白牌支架的三大痛点',
    'pains.lede': 'VIEMAG 的设计，正是从白牌配件最常见的抱怨开始。',
    'pains.1.title': '撑不过一个坑洞',
    'pains.1.desc': '白牌都说磁力很强，实际过个减速丘、切个弯就滑下去，手机摔进脚踏垫，导航直接中断。',
    'pains.1.fix': 'N52 强磁阵列，并以实路况震动测试验证吸持力。',
    'pains.2.title': '吸盘经常掉下来',
    'pains.2.desc': '吸盘制作工艺差，几天就会掉下来，如果在车上瞬间掉落，容易发生意外。',
    'pains.2.fix': 'PU 特殊材质吸盘设计，平面都能吸附。',
    'pains.3.title': '三个月就开始点头',
    'pains.3.desc': '球头与铰链用久松脱，车一震手机就往下垂，最后你得一只手扶着开车。',
    'pains.3.fix': '球头铰链耐久测试加数千次吸合循环，角度锁得住。',
    'cats.kicker': '五大产品线',
    ...
    'mount.vent': '出风口',
    'mount.dashboard': '仪表板',
    'mount.suction': '真空吸盘', 'mount.pu-suction': '纳米胶吸盘',
    'mount.clip': '弹簧夹', 'mount.clamp': '旋转夹持', 'mount.screw': '螺丝锁固',
    'mount.quarter-inch': '1/4" 相机螺牙', 'mount.magnetic': '磁吸底座',
    'mount.magsafe': '兼容 MagSafe',
    'mount.tape': '3M 贴片',
    'mount.screen': '屏幕边夹',
    'mount.desktop': '桌面',
    'why.title': '为什么选 VIEMAG？',
    'why.sub': '在便宜的白牌与昂贵的高端品牌之间，VIEMAG 站在合理的位置：查得到的品质、搆得着的价格。',
    'why.claims.title': '我们的承诺',
    'why.c1.t': '更稳固',
    'why.c1.d': 'N52 超强磁铁，通过多方向磁力推拉实测与实路况震动测试，让您的手机稳固吸附于 VIEMAG 的产品上。',
    'why.c2.t': '更牢靠',
    'why.c2.d': '我们采用高品质吸盘、特殊材质PU黏胶吸盘、3M保证亚克力胶、专业机构设计，每个固定方式都牢靠，VIEMAG 承载您与手机的安全。',
    'why.c3.t': '更耐用',
    'why.c3.d': '每一个关节、转轴与结合机构都经过转轴开合、球头、吸合循环与跌落等耐久测试，长时间使用仍能维持品质，VIEMAG 值得您信赖。',
    'why.c4.t': '充电更安心',
    ...
    'dealers.sub': 'VIEMAG 寻找真正想把货卖动的伙伴——有动销意愿、守价格纪律、能承接售后。',
    ...
    'about.story1': 'VIEMAG 源自一个简单的观察：手机是一天中被拿起、放下最多次的物件，但多数固定它的配件都做得很随便——磁吸不紧、固定不牢靠、用几个月关节就松动。',
    'about.story2': '我们相信好的配件应该像工艺品一样，有美感、有格调，设计卓越，品质出众。VIEMAG 这个名字承载四个承诺：',
    'about.story3': '',
    'about.v': '超越价格的价值定位。',
    'about.i': '洞察并满足您的需求。',
    'about.e': '追求每个细节与品质。',
    ...
    'footer.legal': 'MagSafe 为 Apple Inc. 商标；Qi 与 Qi2 为 Wireless Power Consortium 商标。VIEMAG 仅描述兼容性，未完成认证前不作任何认证宣称。',
  ...
  id: {
    ...
    'products.aboutBody': 'Katalog VIEMAG disusun berdasarkan lini produk, mengikuti tempat produk digunakan: di mobil, di meja kerja, atau saat bepergian. Setiap kode produk (A01, PQ02, V01…) mewakili satu konfigurasi pemasangan dan pengisian daya tertentu, sehingga model dalam satu lini bisa dibandingkan langsung.',
    ...
    'pdp.spec.dimensions': 'Dimensi produk',
    ...
    'pdp.discontinued': 'Produk ini sudah tidak dijual. Halaman tetap ada agar Anda bisa melihat spesifikasi dan menghubungi dukungan.',
    ...
    'mount.vent': 'Kisi AC', 'mount.dashboard': 'Dasbor',
    'mount.suction': 'Sedotan vakum', 'mount.pu-suction': 'Bantalan perekat nano',
    'mount.clip': 'Klip pegas', 'mount.clamp': 'Penjepit putar', 'mount.screw': 'Dipasang sekrup',
    'mount.quarter-inch': 'Baut kamera 1/4"', 'mount.magnetic': 'Dudukan magnetik',
    ...
    'why.c1.t': 'Lebih stabil', 'why.c1.d': 'Magnet N52 bertenaga tinggi, terbukti lewat uji gaya tarik–dorong multi-arah dan getaran dari jalan nyata — ponsel Anda menempel kuat di setiap produk VIEMAG.',
    'why.c2.t': 'Lebih kokoh', 'why.c2.d': 'Cangkir hisap premium, bantalan lem PU khusus, perekat akrilik 3M, dan desain mekanis profesional — setiap metode pemasangan kokoh. VIEMAG menjaga keselamatan Anda dan ponsel.',
    ...
    'support.p2': 'Cacat saat tiba: diganti dalam {d} hari (dengan foto/video).',
    ...
    'dealers.w2.t': 'Bukti kualitas', 'dealers.w2.d': 'Laporan uji dan garansi {m} bulan sebagai senjata jual Anda.',
    ...
    'about.story1': 'VIEMAG lahir dari pengamatan sederhana: ponsel adalah benda yang paling sering diangkat dan diletakkan sepanjang hari, tapi kebanyakan aksesori yang memegangnya dibuat asal-asalan: magnet lemah, pemasangan tidak kokoh, sendi kendur dalam hitungan bulan.',
    'about.story2': 'Kami percaya aksesori yang baik harus dibuat seperti karya kriya — punya estetika, punya karakter, desain unggul, dan kualitas menonjol. Nama VIEMAG membawa empat janji:',
    'about.story3': '',
