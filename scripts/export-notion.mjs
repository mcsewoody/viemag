...
const STATIC = {
  ...
  tests: [
    ...
    { id: 'thermal', icon: 'thermo', name: { vi: 'Kiểm tra tăng nhiệt', en: 'Thermal-Rise Testing', id: 'Uji Kenaikan Suhu', zh: '溫升測試' }, desc: { vi: 'Theo dõi nhiệt độ suốt chu kỳ sạc để giữ máy luôn mát.', en: 'Charge-cycle temperature profiling keeps phones cool.', id: 'Pemantauan suhu sepanjang siklus pengisian menjaga ponsel tetap adem.', zh: '全充電週期溫度監控，手機不燙手。' } },
